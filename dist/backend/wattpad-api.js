...
exports.parsePointsFromText = parsePointsFromText;
exports.processCommentsForPoints = processCommentsForPoints;
exports.createLeaderboard = createLeaderboard;
exports.fetchAllRepliesAndReturnAllComments = fetchAllRepliesAndReturnAllComments;
exports.fetchWattpadData = fetchWattpadData;
const axios_1 = __importDefault(require("axios"));
// Use relative path that will work after compilation
const config_1 = __importDefault(require("../config"));
// Debug log for config
console.log('Loaded config at import time:', JSON.stringify(config_1.default, null, 2));
/**
...
function parsePointsFromText(text) {
    if (!text)
        return { maxPoints: 0, pointsFound: false };
    let maxPoints = 0;
...
async function fetchAllRepliesAndReturnAllComments(comments) {
    ...
    for (const comment of commentsWithReplies) {
        try {
            ...
            const repliesResponse = await axios_1.default.get(repliesUrl);
...
async function fetchWattpadData() {
    ...
    console.log('Config:', config_1.default); // Debug log
    // Hardcoded chapter ID as fallback in case of config issues
    const chapterId = config_1.default.chapterId || "1573385572";
...
//# sourceMappingURL=wattpad-api.js.map